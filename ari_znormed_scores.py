...
scores = []
data_book = xlsxwriter.Workbook("/home/vladimir/Desktop/po_projekat/Affy/ARI/ARI_znormed_results.xlsx")
...
pio.write_image(fig, file='/home/vladimir/Desktop/po_projekat/Affy/ARI/ari_znormed_scores.png', format='png')
