...
from ari_scores_znormed import ari_scores_znormed
...
scores = []
data_book = xlsxwriter.Workbook("/home/milica/Desktop/po/projekat_po1/Affy/ARI/ARI_znormed_results.xlsx")
...
for i in range(0,len(data_file_names)):
    ...
    ari = ari_scores_znormed(np.array(data,dtype=float),label,data_file_names[i])
    scores.append(ari)
print('\n')
print(scores)
...
pio.write_image(fig, file='/home/milica/Desktop/po/projekat_po1/Affy/ARI/ari_znormed_scores.png', format='png')
