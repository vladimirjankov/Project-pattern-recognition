...
from support_functions import distance_matrix,percentage_normalise_z,distance_matrix_np
...
def ari_scores_zpercentage_normed(data,labels,name,p1,p2):
    
    data = np.transpose(percentage_normalise_z(data,p1,p2) )
...
#radi normalno
    ...
    return [name,ari_cosine,ari_braycurtis,ari_correlation,ari_canberra,ari_wasserstein,ari_energy,ari_kulczynski,ari_eucl]
# -*- coding: utf-8 -*-
#ari_hellinger
